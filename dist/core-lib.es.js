...
//#endregion
//#region src/types/quasarDate.ts
var ad = "YYYY/MM/DD";
//#endregion
...
function Cf(e, t) {
	return {
		...
		children: e.children?.map((e) => Cf(e, t)) || [],
		meta: e.meta ? wf(e.meta, t) : void 0
	};
}
function wf(e, t) {
	if (typeof e == "string") return Xu().renderString(e, { config: t });
	if (Array.isArray(e)) return e.map((e) => wf(e, t));
	if (typeof e == "object" && e) {
		let n = {};
		for (let r in e) n[r] = wf(e[r], t);
		return n;
	}
	return e;
}
...
async function Ef(e, t, n) {
	let r = await xf(t);
	r && r.map((e) => Cf(e, t)).forEach((e) => {
		e.name && n.hasRoute(e.name) && n.removeRoute(e.name), n.addRoute(e);
	});
	let i = xu(await Sf(t), (e) => Xu().renderString(e, { config: t }));
	if (i) {
...
async function jf(e) {
	let { router: t, remotes: n, modules: r, localComponents: i } = e, a = { ...Af };
	Object.entries(e.hooks ?? {}).forEach(([e, t]) => {
		let n = Af[e];
		a[e] = async (e, r, i) => (await n(e, r, i), t(e, r, i));
	}), ee(n), ue(F()), i && he(i);
	let o = await bf(r), s = /* @__PURE__ */ new Map();
	for (let e of o) {
