import type { NamedColor, QAvatarProps, QBadgeProps, QBannerProps, QBtnDropdownProps, QBtnProps, QCardActionsProps, QCardProps, QCheckboxProps, QChipProps, QDateProps, QDialogProps, QFieldProps, QFileProps, QFormProps, QHeaderProps, QIconProps, QImgProps, QInputProps, QItemLabelProps, QItemProps, QItemSectionProps, QLayoutProps, QListProps, QMenuProps, QOptionGroupProps, QRouteTabProps, QScrollAreaProps, QSelectProps, QSeparatorProps, QSpinnerProps, QSplitterProps, QTableProps, QTabsProps, QToggleProps, QToolbarProps, QToolbarTitleProps, QTreeProps, VueClassProp, VueStyleObjectProp, VueStyleProp } from 'quasar';
/**
...
declare const Q_SCROLL_AREA_PROPS: readonly ["visible", "delay", "dark", "verticalOffset", "horizontalOffset", "barStyle", "verticalBarStyle", "horizontalBarStyle", "thumbStyle", "verticalThumbStyle", "horizontalThumbStyle", "contentStyle", "contentActiveStyle"];
/**
 ...
 */
export declare const THIRD_PARTY_COMPONENT_PROPS: Record<ThirdPartyComponentName, readonly string[]>;
/**
 ...
 */
export type LinidQOptionGroupProps = Pick<QOptionGroupProps, (typeof Q_OPTION_GROUP_PROPS)[number]>;
/**
 * Subset of QScrollArea props supported in UI design configuration.
 */
export type LinidQScrollAreaProps = Pick<QScrollAreaProps, (typeof Q_SCROLL_AREA_PROPS)[number]>;
/**
 ...
 */
export type LinidQComponentProps = LinidQAvatarProps | LinidQBadgeProps | LinidQBannerProps | LinidQBtnDropdownProps | LinidQBtnProps | LinidQCardActionsProps | LinidQCardProps | LinidQCheckboxProps | LinidQDateProps | LinidQDialogProps | LinidQFieldProps | LinidQFileProps | LinidQFormProps | LinidQHeaderProps | LinidQIconProps | LinidQChipProps | LinidQImgProps | LinidQInputProps | LinidQItemLabelProps | LinidQItemProps | LinidQItemSectionProps | LinidQListProps | LinidQMenuProps | LinidQOptionGroupProps | LinidQRouteTabProps | LinidQScrollAreaProps | LinidQSelectProps | LinidQSeparatorProps | LinidQSpinnerProps | LinidQSplitterProps | LinidQTableProps | LinidQTabsProps | LinidQToggleProps | LinidQToolbarProps | LinidQToolbarTitleProps | LinidQTreeProps;
/**
 ...
 */
export type QComponentName = 'q-avatar' | 'q-badge' | 'q-banner' | 'q-btn' | 'q-btn-dropdown' | 'q-card' | 'q-card-actions' | 'q-checkbox' | 'q-date' | 'q-dialog' | 'q-field' | 'q-file' | 'q-form' | 'q-header' | 'q-icon' | 'q-chip' | 'q-img' | 'q-input' | 'q-item' | 'q-item-label' | 'q-item-section' | 'q-layout' | 'q-list' | 'q-menu' | 'q-option-group' | 'q-route-tab' | 'q-scroll-area' | 'q-select' | 'q-separator' | 'q-spinner' | 'q-splitter' | 'q-table' | 'q-tabs' | 'q-toggle' | 'q-toolbar' | 'q-toolbar-title' | 'q-tree';
/**
