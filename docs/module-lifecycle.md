...
The corelib provides a `ModuleLifecycleBase` abstract class for implementation:

```typescript
import { ModuleLifecycleBase } from '@linagora/linid-im-front-corelib';
import type { ModuleLifecycleResult } from '@linagora/linid-im-front-corelib';
import type { App } from 'vue';

class MyModule extends ModuleLifecycleBase {
  constructor() {
...
Implement the `RemoteModule` interface directly:
...
```typescript
class SimpleModule extends ModuleLifecycleBase {
  constructor() {
...
2. ✅ Implementing the `RemoteModule` interface (or extending `ModuleLifecycleBase`)
...
- [Types and Interfaces](./types-and-interfaces.md) - Complete TypeScript type definitions
- [Components and Zones](./components-plugin-zones.md) - Zone system documentation
...
class MinimalModule extends ModuleLifecycleBase {
  constructor() {
...
class FullModule extends ModuleLifecycleBase {
