...
import { type ConfirmationDialogEvent } from '../types/dialogType';
 ...
 * @returns D.
 */
export function useDialog(onOpen?: (event: ConfirmationDialogEvent) => void) {
  ...
  function onDialogEvent(event: UiEvent) {
    ...
    const dialogEvent = event.data as ConfirmationDialogEvent;
