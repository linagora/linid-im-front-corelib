...
/**
 * Singleton Dayjs instance shared across all modules.
 */
let dayjsInstance: typeof dayjs | null = null;
 ...
 */
export function setDayjsInstance(instance: typeof dayjs): void {
 ...
 * @returns The shared Dayjs instance.
 */
export function getDayjsInstance(): typeof dayjs {
  if (dayjsInstance === null) {
    throw new Error(
