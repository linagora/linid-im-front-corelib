 ...
 * @returns The Linid UI Store instance.
 */
export const useLinidUiStore = () => _useLinidUiStore(getPiniaStore());

/**
 * Pinia store managing Linid UI metadata.
 *
 * This store holds information that can be used by all layouts and components.
 */
