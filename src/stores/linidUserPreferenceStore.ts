 ...
 * @returns The Linid User Preference Store instance.
 */
export const useLinidUserPreferenceStore = () =>
  _useLinidUserPreferenceStore(getPiniaStore());

/**
 * Pinia store to manage user preferences.
 */
const _useLinidUserPreferenceStore = defineStore('LinidUserPreferenceStore', {
  /**
   * State properties of the user preference store.
   * @returns The initial state of the user preference store.
   */
  state: (): LinidUserPreferenceState => ({
    userPreferences: {},
  }),
  ...
  actions: {
     ...
     */
    setUserPreferences(values: Record<string, string>) {
