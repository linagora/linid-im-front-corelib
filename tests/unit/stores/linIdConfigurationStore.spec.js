...
describe('Test store: linIdConfigurationStore', () => {
  ...
  describe('Test getter: getRoutesByEntity', () => {
    ...
    it('should return routes with null entity when searching for null', () => {
      store.routes = [
        { method: 'GET', path: '/health', entity: null, variables: [] },
        { method: 'GET', path: '/users', entity: 'user', variables: [] },
      ];

      const result = store.getRoutesByEntity(null);
